...
abstract class ModelTestCase extends TestCase
{
    ...
    protected function assertBelongsToManyRelation($related, $foreignPivotKey = null, $relatedPivotKey = null)
    {
        $this->assertInstanceOf(BelongsToMany::class, $related);

        if (is_null($foreignPivotKey)) {
            $foreignPivotKey = $related->getForeignPivotKeyName();
        }

        $this->assertEquals($foreignPivotKey, $related->getForeignPivotKeyName());

        if (is_null($relatedPivotKey)) {
            $relatedPivotKey = $related->getRelatedPivotKeyName();
        }

        $this->assertEquals($relatedPivotKey, $related->getRelatedPivotKeyName());
    }
}
